...
1. Create new SlashCommands Class inside de.mme.qbot.logics.discordapi.slashcommand, e.g. EchoSlashCommand extending
...
2. Go to de.mme.qbot.configs.discordapi and add a new private Method, that will instatioate the new SlashCommand object.
